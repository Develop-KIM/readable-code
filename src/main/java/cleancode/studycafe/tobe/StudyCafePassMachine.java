...
public class StudyCafePassMachine {
    ...
    private List<StudyCafePass> findPassCandidatesBy(StudyCafePassType selectedPassType) {
    ...
    private StudyCafeLockerPass findLockerPassCandidateBy(StudyCafePass pass) {
        ...
        return allLockerPasses.stream()
            .filter(lockerPass ->
                lockerPass.getPassType() == pass.getPassType() && lockerPass.getDuration() == pass.getDuration()
            )
            .findFirst()
            .orElse(null);
    }
